...
Create local rstudio project of
https://github.com/wstolte/PizzaCourse2atDeltares
(requires Git installation)

try some templates

alt: download repos and start Rstudio project there
...
Start rstudio project from 
https://github.com/wstolte/pizzaParameterizedRmarkdown

And run script GenerateFactSheetsOpdrachtnemer.R
...
* Footnotes
* Literature references using bibtex
* Knit multiple files to one document
    + All .Rmd files in director that do not start with "_"
    + Alt, specify .Rmd files in yaml
    + Use child documents
...
* Built-in formats
    + Gitbook
    + Tufte handout and html
* Tools for making your own templates

[home to bookdown](https://bookdown.org/yihui/bookdown/)

## Excercise

Start Rstudio project from https://github.com/wstolte/PizzaCourseBookdown

Plenary explanation, then play around with it. 


## Python scripts


## Deltares report pdf template
